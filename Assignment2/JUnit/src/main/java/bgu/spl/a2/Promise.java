...
public class Promise<T> {
    ...
    private void setResult(T value) throws Exception{
        semaphore.acquire();
        try{
            if(!isResolved()) {
                result = value;
    ...
    private void addToLinkedList(callback callback) throws Exception{
        semaphore.acquire();
        try{
            if(!isResolved()) {
    ...
    private void linkedListWhileResolve() throws Exception{
        semaphore.acquire();
        try{
